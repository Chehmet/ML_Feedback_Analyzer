"""
Данный код предназначен для анализа набора данных отзывов, хранящихся в формате JSON. Он выполняет следующие основные задачи:
1. Выявляет случаи, когда рецензент оставил отзыв на самого себя.
2. Создает множества идентификаторов рецензентов и работников.
3. Находит пересечение этих множеств.
"""
import json
